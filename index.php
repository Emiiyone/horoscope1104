...
define('RADIUS', 210);				//外側の円の半径
define('WIDTH1', 35);				//星座を描く部分の幅

//ホロスコープの表示色
define('COLOR1', '#333');		//星座配置部分の色
define('COLOR2', '#fff');		//惑星配置部分の色
define('COLOR3', '333');		//境界線の色
define('COLOR4', '#fff');		//星座アイコンの色
define('COLOR5', '#333');		//惑星アイコンの色
...
array('Aries',			'白羊宮', '空条 承太郎',	'U+2648', '0321',	0),
array('Taurus',			'金牛宮', 'ジョセフ・ジョースター',	'U+2649', '0420',	30),
array('Gemini',			'双児宮', 'ジャン・ピエール・ポルナレフ', 'U+264A', '0521',	60),
array('Cancer',			'巨蟹宮', '花京院 典明', 'U+264B', '0622',	90),
array('Leo',			'獅子宮', 'DIO', 'U+264C', '0723',	120),
array('Virgo',			'処女宮', '東方 仗助', 'U+264D', '0823',	150),
array('Libra',			'天秤宮', '億村兄弟', 'U+264E', '0923',	180),
array('Scorpio',		'天蝎宮', 'ジョルノ・ジョバァーナ',	'U+264F', '1024',	210),
array('Sagittarius',	'人馬宮', 'ブローノ・ブチャラティ',	'U+2650', '1123',	240),
array('Capricorn',		'磨羯宮', 'グイード・ミスタ', 'U+2651', '1222',	270),
array('Aquarius',		'宝瓶宮', '空条 徐倫',	'U+2652', '0120',	300),
array('Pisces',			'双魚宮', 'エルメェス・コステロ', 'U+2653', '0219',	330)
);
...
function makeSelectZodiac($zd) {
	...
	$html =<<< EOD
<p class="select_ttl">推しキャラを選ぶッ！</p>　<select name="zodiac" id="zodiac">
...
<div class="color"><p>{$hexcolor}</p></div>
<div class="caractor">
<div class="{$zd}"></div>
</div>
</body>
...
<div class="wrapper">
	<div class="contents">
		<h2><img src="img/ttle.png" alt="JOJO's Haapy Color"> </h2>
		<form name="myform" method="get" action="{$myself}">
		<p class="coment">占いたい日を入力だッ！</p>
		...
		<div class="btn">
			<span id="koe01"><input type="submit" id="exec" name="exec" value="色を占うッ！" /></span>
			<!-- <input type="button" onclick="ring()" id="voice" name="voive" value="voice" /> -->
			<audio id="sound01">
   				<source src="voice/nc90547.wav" type="audio/wav">
			</audio>
			<span id="koe02"><input type="submit" id="clear" name="clear" value="やれやれだぜ" /></span>
			<audio id="sound02">
   				<source src="voice/nc69901.mp3" type="audio/mp3">
			</audio>
		</div>
